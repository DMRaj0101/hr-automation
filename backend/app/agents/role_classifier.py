...
def _rule_based_fallback(department: str, title: str, roles_config: dict) -> dict:
    ...
    # TODO: "Law" is an arbitrary default for a department/title that
    # matches none of the four roles (e.g. Marketing, HR) -- fine for
    ...
    return {"role": "Law", "confidence": 0.3, "reasoning": "No match found; defaulted (Ollama unavailable)."}
