...
source), WelcomeEmail, and the HR Assistant / Knowledge Agent chatbot
models (PolicyDocument, PolicyChunk, Conversation, Message).
...
# ==========================================================
# Knowledge Agent -- HR Assistant chatbot models (kept, unchanged)
# ==========================================================
